...
res <- evalm(list(svm, svm_pca, knn, knn_pca, glm, rf, dt), gnames = c('svm','svm_pca','knn', 'knn_pca', 'glm','rf', 'dt'),rlinethick=0.8,fsize=30, showplots = TRUE , bins=20, plots = c("prg"))

```

```{r ,echo=FALSE,message=FALSE, warning=FALSE, fig.height=18, fig.width=18}
res <- evalm(list(svm, svm_pca, knn, knn_pca, glm, rf, dt), gnames = c('svm','svm_pca','knn', 'knn_pca', 'glm','rf', 'dt'),rlinethick=0.8,fsize=30, optimise="MCC", showplots = TRUE , bins=20, plots = c("pr"))

```

```{r ,echo=FALSE,message=FALSE, warning=FALSE, fig.height=18, fig.width=18}
res <- evalm(list(svm, svm_pca, knn, knn_pca, glm, rf, dt), gnames = c('svm','svm_pca','knn', 'knn_pca', 'glm','rf', 'dt'),rlinethick=0.8,fsize=30, optimise="MCC", showplots = TRUE , bins=20, plots = c("r"))

```

```{r ,echo=FALSE,message=FALSE, warning=FALSE, fig.height=18, fig.width=18}
res <- evalm(list(svm, svm_pca, knn, knn_pca, glm, rf, dt), gnames = c('svm','svm_pca','knn', 'knn_pca', 'glm','rf', 'dt'),rlinethick=0.8,fsize=30, optimise="MCC", showplots = TRUE , bins=20, plots = c("cc"))
