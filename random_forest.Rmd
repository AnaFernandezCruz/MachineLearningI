...
```{r message = FALSE, warning=FALSE}
##MATRIZ CONFUSION
house.predmodel_nopca <- predict(model_nopca, newdata = XPCATest)
...
model_nopca_predict <- predict(model_nopca, newdata = XPCATest, type = "prob")
model_nopca_predict$obs <- YPCATest
