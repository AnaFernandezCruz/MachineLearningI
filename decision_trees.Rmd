...
Vemos que después de añadir las probabilidades a priori el accuracy del modelo se mantiene constante aunque el error ha aumentado sutilmente en este segundo modelo. Vamos a proceder a seguir nuestro estudio con el primer árbol que hemos entrenado ya que, a accuracys similares, el primero tiene menos error. 
