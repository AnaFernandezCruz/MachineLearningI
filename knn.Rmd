...
set.seed(400)
ctrl <- trainControl(method="repeatedcv", repeats = 3, classProbs = TRUE, summaryFunction = twoClassSummary, metric="ROC", savePredictions = TRUE, sampling = "smote")
...
set.seed(400)
ctrl_pca <- trainControl(method="repeatedcv",repeats = 3,classProbs = TRUE, summaryFunction = twoClassSummary, metric="ROC", savePredictions = TRUE, sampling = "smote")
